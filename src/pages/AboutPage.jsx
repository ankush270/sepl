...
export default function AboutPage() {
  ...
  return (
    <div className="bg-slate-50 min-h-screen pt-12 pb-24 text-left animate-in fade-in duration-300">
      ...
      {/* Philosophy Grid */}
      <div className="max-w-[1440px] mx-auto px-4 sm:px-8 lg:px-12 xl:px-16 grid grid-cols-1 lg:grid-cols-2 gap-16 items-stretch mb-24">
          ...
          <div className="space-y-4">
            <div className="flex items-start gap-4 p-5 bg-white border border-slate-100 rounded-2xl shadow-sm">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400 mt-1 leading-relaxed">To coordinate essential healthcare, progressive academic learning, and retail luxury under a unified standard of absolute integrity.</p>
              </div>
            </div>
            <div className="flex items-start gap-4 p-5 bg-white border border-slate-100 rounded-2xl shadow-sm">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400 mt-1 leading-relaxed">To unlock standard operational scaling across 10 verticals while directly enriching the social fabrics of coastal Karnataka.</p>
              </div>
            </div>
          </div>
        </div>
        <div className="relative rounded-[32px] overflow-hidden aspect-[4/3] lg:aspect-auto lg:h-full min-h-[300px] shadow-lg bg-slate-100">
