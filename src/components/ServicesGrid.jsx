...
export default function ServicesGrid() {
  const verticals = [
    ...
    },
    {
      ...
      desc: 'IIT JEE/NEET coaching. Includes SEPLCO Tutorials, SEPLCO Music, and SEPLCO Sports.',
      icon: GraduationCap,
    ...
    },
    {
      ...
      desc: 'Holistic educational institution rooted in values and excellence.',
      icon: Baby,
    ...
    },
    {
      ...
      desc: 'Thoughtfully developed spaces for living, working, and investing.',
      icon: Music4,
      path: '/services#properties-hospitality',
    },
  ];
